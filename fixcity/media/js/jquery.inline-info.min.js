(function($){$.fn.inlineInfoTextify=function(options){var defaults={inlineInfoClass:"overlabel",inlineInfoText:"",caseSensitiveMatch:false,blankFieldOnSubmitWhenDefault:true};var options=$.extend(defaults,options);var removeLabel=function(target){(target.attr('value')!==undefined)?target.removeClass(options.inlineInfoClass).val(""):target.removeClass(options.inlineInfoClass).text("");}
var addLabel=function(target,replaceWithText){(target.attr('value')!==undefined)?target.addClass(options.inlineInfoClass).val(replaceWithText):target.removeClass(options.inlineInfoClass).text(replaceWithText);}
